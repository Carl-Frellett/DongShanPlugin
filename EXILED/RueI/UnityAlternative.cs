...
public class NonUnityProvider : UnityAlternative
{
    ...
    /// <inheritdoc/>
    internal override void ShowHint(ReferenceHub hub, string message) => hub.networkIdentity.connectionToClient.Send(new HintMessage(new TextHint(message, new HintParameter[] { new StringHintParameter(message) }, null, 99999)));
