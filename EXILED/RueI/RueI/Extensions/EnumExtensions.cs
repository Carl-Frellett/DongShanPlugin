...
public static class EnumExtensions
{
    ...
    /// <summary>
    /// Quickly determines if a <see cref="Roles"/> has a <see cref="RoleType"/>.
    /// </summary>
    /// <param name="first">The first <see cref="Roles"/>.</param>
    /// <param name="second">The other <see cref="Roles"/>.</param>
    /// <returns>A value indicating whether or not the first has the <see cref="RoleType"/> of the second.</returns>
    public static bool HasFlagFast(this Roles first, RoleType second)
    {
