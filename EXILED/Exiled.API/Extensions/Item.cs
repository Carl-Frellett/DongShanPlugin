...
namespace Exiled.API.Extensions
{
    ...
    public static class Item
    {
        ...
        /// <summary>
        /// Check if an <see cref="ItemType">item</see> is a throwable.
        /// </summary>
        /// <param name="type"></param>
        /// <returns>Returns whether the <see cref="ItemType"/> is a throwable or not.</returns>
        public static bool IsThrowable(this ItemType type) => type == ItemType.GrenadeFlash || type == ItemType.GrenadeFrag;
